...
void setParameters(int argc, char** argv) 
{
    switch (argc)
    {
        ...
        default: MAX_PARTICLES = 10000000; NUM_ITERATIONS = 100; TPB = 256; DEC_FACTOR = 0.9; break; 
    }
}
...
int main(int argc, char **argv)
{
    ...
    cudaMemcpy(pGPU, pCPU, MAX_PARTICLES * sizeof(Particle), cudaMemcpyHostToDevice);
